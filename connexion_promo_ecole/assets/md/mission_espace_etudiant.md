...
* **Dépôt de devoirs** avec vérification du nom du fichier.
...
##  Planning (a voir avec l'avancé du projet)
 ...
 Analyse des besoins          5 jour        
 Maquettes (avec Mathieu)     5 jour        
 Conception de la BDD         2 jours       
 Dev interface Étudiant       10 jours       
 Dev interface Admin          10 jours       
 Intégration email + suivi    5 jours       
 Phase de test & corrections  10 jours       
